...
# Audit checkpoint [2026-04-09]: feat(client-onboarding): add automated model card parser for tenant risk evaluation

# Audit checkpoint [2026-05-26]: fix(guardrails): patch safety boundary bypass detection for client conversational agent
